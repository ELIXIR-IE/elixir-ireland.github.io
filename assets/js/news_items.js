const newsItems = [
  {
    ...
    date: "2026-09-07",
    summary: "A new EOSC Ireland report captures lessons from visits to six established European EOSC Nodes: the EOSC EU Node, EOSC Poland, SURF (Netherlands), EOSC Finland, PaNOSC and LS Connect. It covers architecture and AAI, service catalogues, governance, funding and sustainability, sensitive data, and community engagement. ELIXIR Ireland contributed to the report through involved project members.",
  ...
  },
  {
    ...
    image: "/assets/images/nature-methods-badge.svg",
  ...
  {
    title: "ELIXIR Ireland Welcomes New Head of Node",
    date: "2025-06-01",
    summary: "ELIXIR Ireland welcomes its new Head of Node Aedín Culhane (UL) who will lead the Node after the role handover from Denis Shields (UCD). We thank Denis for his years of stewardship and operationalisation of ELIXIR Ireland.",
    image: "/assets/images/ul.jpeg",
    link: "/news/aedin-culhane-head-of-node/"
  }
];
